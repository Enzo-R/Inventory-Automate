...
namespace TrainingVSTO.Models
{
    public static class Excel
    {
        ...
        {
            get { return @"C:\Users\EROLIVEIRA\OneDrive - Joyson Group\Inventory\"; }
        }
        ...
        public static string PathToServer = @"C:\Log_Planej_Adm\CY Inventory Tracking\Relatório Estoque Geral\2023\M7 - STK 10-23\M7 - STK " + dateValidate + " -.xlsx";
